  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-12 px-6 relative">
      ...
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        ...
        <h1 className="text-5xl font-bold text-white tracking-tight leading-tight">Privacy <span className="text-blue-400">Policy</span>.</h1>
        <p className="text-zinc-500 text-lg leading-relaxed">Last updated: October 25, 2023. We are committed to protecting your personal data and your privacy.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="glass-card p-10 text-center space-y-6">
          ...
          <p className="text-zinc-500 text-lg max-w-xl mx-auto leading-relaxed">If you have any questions or concerns about our Privacy Policy, please contact our data protection officer.</p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-4">
            <div className="flex items-center space-x-3 px-6 py-3 bg-zinc-900 rounded-2xl border border-zinc-800">
              <Mail className="w-5 h-5 text-blue-400" />
              <span className="text-white font-medium">privacy@vicoapps.com</span>
            </div>
            <div className="flex items-center space-x-3 px-6 py-3 bg-zinc-900 rounded-2xl border border-zinc-800">
