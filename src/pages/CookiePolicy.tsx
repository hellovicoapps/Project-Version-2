    ...
    <div className="max-w-4xl mx-auto space-y-12 py-12 px-6 relative">
      ...
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        <div className="inline-flex p-3 bg-[var(--brand-primary)]/10 rounded-2xl border border-[var(--brand-primary)]/20 mb-4">
          <Cookie className="w-6 h-6 text-[var(--brand-primary)]" />
        </div>
        <h1 className="text-5xl font-bold text-main tracking-tight leading-tight">Cookie <span className="text-[var(--brand-primary)]">Policy</span>.</h1>
        <p className="text-muted text-lg leading-relaxed">Last updated: October 25, 2023. We use cookies to improve your experience on our platform.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <Section title="Managing Cookies" icon={Lock}>
          ...
          <p>For more information on how to manage cookies, please visit your browser's help center or visit <a href="https://www.allaboutcookies.org" className="text-[var(--brand-primary)] hover:text-[var(--brand-primary)]/80 transition-colors">www.allaboutcookies.org</a>.</p>
        </Section>

        <div className="glass-card p-10 text-center space-y-6">
          <h2 className="text-2xl font-bold text-main tracking-tight">Need Help?</h2>
          <p className="text-muted text-lg max-w-xl mx-auto leading-relaxed">If you have any questions about our Cookie Policy, please contact our support team.</p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-4">
            <div className="flex items-center space-x-3 px-6 py-3 bg-card rounded-2xl border border-border-main">
              ...
              <span className="text-main font-medium">support@vico.ai</span>
            </div>
            <div className="flex items-center space-x-3 px-6 py-3 bg-card rounded-2xl border border-border-main">
